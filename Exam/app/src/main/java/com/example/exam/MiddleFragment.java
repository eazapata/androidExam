...
public class MiddleFragment extends Fragment {
    ...
    public void editText(int red,int green, int blue, float size,String text){
        userText = (TextView) view.findViewById(R.id.textWrapper);
        userText.setTextSize(size);
        userText.setText(text);
        userText.setTextColor(Color.rgb(red,green,blue));
    }
